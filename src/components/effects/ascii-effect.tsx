...
type ColorPalette = "original" | "green" | "amber" | "cyan" | "blue";
...
interface PostFxOptions {
  ...
  colorPalette?: number | ColorPalette;
  curvature?: number;
...
class AsciiEffectImpl extends Effect {
  constructor(options: AsciiEffectImplOptions = {}) {
    ...
    const palette =
      typeof postfx.colorPalette === "number"
        ? postfx.colorPalette
        : paletteMap[postfx.colorPalette ?? "original"];
    ...
    const uniforms = new Map<string, Uniform<unknown>>([
        ...
        ["colorPalette", new Uniform(palette)],
